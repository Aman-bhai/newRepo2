...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "emp/demo/project1/test/integration/FirstJourney",
    "emp/demo/project1/test/integration/EmployeesListJourney",
    "emp/demo/project1/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
