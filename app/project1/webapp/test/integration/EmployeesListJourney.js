...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheEmployeesList.onTable().iCheckColumns(undefined, {"firstName":{"header":"firstName"},"lastName":{"header":"lastName"},"email":{"header":"email"},"phone":{"header":"phone"},"department":{"header":"department"},"salary":{"header":"salary"},"hireDate":{"header":"hireDate"}});
